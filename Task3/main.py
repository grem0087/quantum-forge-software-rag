...
from config import KNOWLEDGE_BASE_DIR, CHROMA_PATH, COLLECTION_NAME, EMBEDDING_MODEL_NAME, CHUNK_SIZE, CHUNK_OVERLAP
...
if __name__ == "__main__":
    ...
    collection = create_or_get_collection(CHROMA_PATH, COLLECTION_NAME)
