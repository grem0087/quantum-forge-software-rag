...
|-----------------------------|----------------------|------------------------|------------------|---------------------------|-----------------------------|---------------------|--------|
| 1. Полностью локальный ★    | Mistral-8B / Llama-4 | BGE-M3 / e5-large      | **ChromaDB**     | On-premise + GPU          | €10–15k разово + €0.5k/год  | Максимальная        | ★★★★★  |
...
Итак в  [./Task2/knowledge_base](./Task2/knowledge_base/) содержатся 30 фай-в с русскими сказками, и заменой основных терминов в них на термины из звездных войн. Файл подмены [./Task2/terms_map.json](./Task2/terms_map.json).
...
**Примечание:** на всё будет очень сильно зависеть и от установленной версии puthon (последняя плохо совместима с выбраной БД, и от окружения), поэтому я на всякий случай приложил собранную БД, как док-во проделанной работы.
...
>>Загружено 37 чанков в ChromaDB
